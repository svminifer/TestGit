...
//		System.out.println(zhangsan);
    ...
    public void mergeMapEg1() {
        ...
        // key一样，取id较大
        Map<String, Player> result = Stream.concat(map1.entrySet().stream(), map2.entrySet().stream())
    ...
    public void mergeMapEg4() {
        Map<String, Player> collect = Stream.concat(playerMap.entrySet().stream(), otherPlayerMap.entrySet().stream()).collect(Collectors.toMap(Map.Entry::getKey, Map.Entry::getValue, (o1, o2) -> o1));
